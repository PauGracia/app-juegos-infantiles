window.translationsEN = {
  ...
  "damas.warning.playerNoStats": "Playing as 'Player' - Statistics will not be saved to the leaderboard",
  "common.yes": "Yes",
  "common.no": "No",
  ...
  "categoria.lugar": "Place",
  "categoria.comida": "Food",
  "categoria.profesion": "Profession",
  "categoria.abstracto": "Abstract concept",
  ...
  "attributions.flaticon":
    "Interface icons provided by Flaticon under free license",
  "attributions.memoriCards": "Card icons - Matching Game",
  "attributions.googleIcons": "Google Material Design Icons",
  "attributions.iconify": "Iconify",
  "attributions.soundsPixabay": "Sound effects from Pixabay",
  "attributions.soundsFreesound": "Sound effects from Freesound",
  "attributions.summaryTitle": "Summary by game",
  "attributions.memori":
    "Matching Game (Memori): Interface icons (Flaticon) | Card icons (Apache/CC0)",
  "attributions.palabras":
    "What's it called (Words): Interface icons (Flaticon) | Card icons (Apache/CC0)",
  "attributions.ahorcado": "Hangman Game: Interface icons (Flaticon)",
  "attributions.damas": "Checkers Game: Interface icons (Flaticon)",
  ...
  "damas.jugadores": "Players",
  "damas.jugadores2": "Player:",
  ...
  "damas.player.error.maxPlayers": "You cannot create more than 10 players",
  "damas.ranking.title": "Player ranking",
  "damas.ranking.noPlayers": "No registered players",
